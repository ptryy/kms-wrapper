// Package keypath holds the canonical {project}/{chain}/{username} validator
...
// the empty string, "<project>", "<project>/<chain>", or a trailing slash on
